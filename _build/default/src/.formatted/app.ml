...
let view model =
  ...
  div
    ...
    ; div
        ...
        [ span
            [ class'
                " w-1/4 text-xl text-center font-body bg-primary-plum \
                 text-background-lavender border-1 rounded-xl" ]
            [view_button model "Oui" Oui]
        ; span
            [ class'
                " w-1/4 text-xl text-center font-body bg-primary-plum \
                 text-background-lavender border-1 rounded-xl" ]
            [view_button model "Non" Non]
        ; p [] [] ]
    ; div
        [class' "flex flex-col justify-center"]
        [ span
            [class' "p-10 text-4xl text-center text-primary-plum font-display"]
            [text response] ] ]
